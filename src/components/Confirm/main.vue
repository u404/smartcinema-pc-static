    ...
    <transition name="h5-slideUp" appear>
      <div class="h5-confirm-body" v-show="visible">
        ...
        <div class="h5-confirm-btns">
          <div class="h5-confirm-btn" @click="sure" :data-pos-x="0" :data-pos-y="0">Confirm</div>
          <div class="h5-confirm-btn" @click="cancel" :data-pos-x="1" :data-pos-y="0">Cancel</div>
        </div>
      </div>
    </transition>
  </div>
